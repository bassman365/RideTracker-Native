...
export default class FinishRideScreen extends Component<Props> {
  ...
  updateDurationSeconds(seconds) {
    ...
    this.setState({ duration }, () => { //eslint-disable-line  react/no-set-state
  ...
  updateDistance(distance) {
    this.setState({ distance: distance }, () => { //eslint-disable-line  react/no-set-state
      this.evaluateCanSubmit();
    });
  }

  updateCalories(calories) {
    this.setState({ calories: calories }, () => { //eslint-disable-line  react/no-set-state
      this.evaluateCanSubmit();
    });
  }
      ...
      <View style={{ flex: 1, flexDirection: 'column' }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
          ...
          <View style={{ flex: 0.8, borderWidth: 0, height: 55 }}>
            ...
            <Picker
              onValueChange={(itemValue, itemIndex) => this.updateDurationHours(itemValue)}
          ...
          <View style={{ flex: 0.8, borderWidth: 0, height: 55 }}>
            ...
            <Picker
              onValueChange={(itemValue, itemIndex) => this.updateDurationMinutes(itemValue)}
          ...
          <View style={{ flex: 0.8, borderWidth: 0, height: 55 }}>
            ...
            <Picker
              onValueChange={(itemValue, itemIndex) => this.updateDurationSeconds(itemValue)}
